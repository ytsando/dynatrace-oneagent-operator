...
func TestHasSpecChanged(t *testing.T) {
	{
		ds := newDaemonSetSpec()
		exp := &newDaemonSetForCR(newOneAgent(), "amd64").Spec
	...
	}
	{
		...
		exp := &newDaemonSetForCR(oa, "amd64").Spec
		...
		Template: corev1.PodTemplateSpec{
			ObjectMeta: metav1.ObjectMeta{
				Labels: map[string]string{
					...
					"oneagent.dynatrace.com/arch":     "amd64",
					"oneagent.dynatrace.com/instance": "my-oneagent",
				},
			},
			Spec: corev1.PodSpec{
